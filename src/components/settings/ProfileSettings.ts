...
export function addProfileSettings(
	...
	new Setting(settingsContainer)
		...
		.addDropdown((dropdown) => {
			...
			dropdown
				.setValue(
					plugin.settings.profiles.profile || DEFAULT_SETTINGS.profiles.profile,
				)
				.onChange(async (value) => {
					plugin.settings.profiles.profile = value
						? value
	...
	new Setting(settingsContainer)
		...
		.addText((text) =>
			text
				...
				.setValue(
					plugin.settings.profiles.profileFolderPath ||
						DEFAULT_SETTINGS.profiles.profileFolderPath,
				)
				.onChange(async (value) => {
					plugin.settings.profiles.profileFolderPath = value
						? value
						: DEFAULT_SETTINGS.profiles.profileFolderPath;
					if (value) {
						let folderPath =
							plugin.settings.profiles.profileFolderPath.trim() ||
							DEFAULT_SETTINGS.profiles.profileFolderPath;
