...
// Prompt Settings
export function addPromptSettings(
	...
	new Setting(settingsContainer)
		.setName("Prompt")
		.setDesc(
			"Select a prompt to provide additional context to the system role.",
		)
		.addDropdown((dropdown) => {
			...
			dropdown
				...
				.onChange(async (value) => {
					plugin.settings.prompts.prompt = value
						? value
	...
	new Setting(settingsContainer)
		...
		.addText((text) =>
			text
				...
				.setValue(
					plugin.settings.prompts.promptFolderPath ||
						DEFAULT_SETTINGS.prompts.promptFolderPath,
				)
				.onChange(async (value) => {
					plugin.settings.prompts.promptFolderPath = value
						? value
						: DEFAULT_SETTINGS.prompts.promptFolderPath;
					if (value) {
						let folderPath =
							plugin.settings.prompts.promptFolderPath.trim() ||
							DEFAULT_SETTINGS.prompts.promptFolderPath;
