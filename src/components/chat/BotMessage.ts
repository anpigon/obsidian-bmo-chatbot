...
import {
	displayAppendButton,
	displayBotCopyButton,
	displayBotEditButton,
} from "./Buttons";
import { addMessage, addParagraphBreaks } from "./Message";
import { MarkdownRenderer, setIcon } from "obsidian";

export function displayBotMessage(
	plugin: BMOGPT,
	...
	if (
		!message.includes("commandBotMessage") &&
		!message.includes("errorBotMessage")
	) {
	...
	const copyCodeBlocks = messageBlockDiv.querySelectorAll(
		".copy-code-button",
...
export function displayCommandBotMessage(
	plugin: BMOGPT,
	settings: BMOSettings,
	messageHistory: { role: string; content: string }[],
	message: string,
